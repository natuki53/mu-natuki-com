export const en = {
  ...
  'admin.backAria': 'Back to the home page',
  'admin.kicker': 'PRIVATE CONTROL ROOM',
  'admin.heading': 'A quiet place to keep everything in order.',
  'admin.desc':
    'A private administration page for reviewing attendance and safely maintaining bots and web apps.',
  'admin.signedIn': 'Signed in',
  'admin.tabsAria': 'Administration menu',
  'admin.tabOverview': 'Overview',
  'admin.tabTimecard': 'Attendance',
  'admin.tabServices': 'Services',
  'admin.tabAudit': 'Audit log',
  'admin.overviewKicker': 'OVERVIEW',
  'admin.overviewHeading': 'The current picture',
  'admin.refresh': 'Refresh',
  'admin.serviceSnapshot': 'Service status',
  'admin.timecardKicker': 'TIMECARD',
  'admin.timecardHeading': 'Review attendance',
  'admin.month': 'Month',
  'admin.member': 'Member',
  ...
  'admin.activeAttendance': 'Current attendance',
  'admin.completedRecords': 'COMPLETED',
  'admin.attendanceRecords': 'Attendance records',
  'admin.clockIn': 'Clock in',
  'admin.clockOut': 'Clock out',
  'admin.breakTime': 'Break',
  'admin.workTime': 'Work',
  'admin.actions': 'Actions',
  'admin.servicesKicker': 'MAINTENANCE',
  'admin.servicesHeading': 'Service management',
  'admin.servicesNote':
    'Databases, tunnels, and deployment services are not available as operation targets.',
  'admin.auditKicker': 'AUDIT TRAIL',
  'admin.auditHeading': 'Operation history',
  'admin.confirmKicker': 'CONFIRMATION',
  'admin.confirmServiceAction': 'Operate this service?',
  'admin.cancel': 'Cancel',
  'admin.execute': 'Run',
  'admin.correctionKicker': 'CORRECTION',
  'admin.correctAttendance': 'Correct attendance record',
  'admin.breakMinutes': 'Break (minutes)',
  'admin.reason': 'Reason for correction',
  'admin.correctionNote':
    'The original values, corrected values, reason, and administrator are recorded in the audit trail.',
  'admin.saveCorrection': 'Save correction',
  'admin.paginationAria': 'Attendance record pages',
